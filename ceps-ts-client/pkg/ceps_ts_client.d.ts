...
export class ClientCEP18 {
  free(): void;
  constructor(rpc_url: string, sse_url?: string | null, verbosity?: Verbosity | null);
  getRPCUrl(): string;
  setRPCUrl(rpc_url: string): void;
  getSSEUrl(): string;
  setSSEUrl(sse_url: string): void;
...
export interface InitOutput {
  ...
  readonly __wbg_clientcep18_free: (a: number, b: number) => void;
  readonly clientcep18_new: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
  readonly clientcep18_getRPCUrl: (a: number) => [number, number];
  readonly clientcep18_setRPCUrl: (a: number, b: number, c: number) => [number, number];
  readonly clientcep18_getSSEUrl: (a: number) => [number, number];
  readonly clientcep18_setSSEUrl: (a: number, b: number, c: number) => [number, number];
  readonly clientcep18_getVerbosity: (a: number) => number;
  readonly clientcep18_setVerbosity: (a: number, b: number) => void;
  readonly clientcep78_new: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
  readonly clientcep78_getRPCUrl: (a: number) => [number, number];
  readonly clientcep78_setRPCUrl: (a: number, b: number, c: number) => [number, number];
  readonly clientcep78_getSSEUrl: (a: number) => [number, number];
  readonly clientcep78_setSSEUrl: (a: number, b: number, c: number) => [number, number];
  readonly clientcep78_setVerbosity: (a: number, b: number) => void;
  readonly clientcep78_getVerbosity: (a: number) => number;
  readonly __wbg_clientcep78_free: (a: number, b: number) => void;
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h987b10193bed3689: (a: number, b: number) => void;
  ...
  readonly closure1572_externref_shim: (a: number, b: number, c: any, d: any) => void;
