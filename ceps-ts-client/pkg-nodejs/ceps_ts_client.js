...
function __wbg_adapter_38(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h987b10193bed3689(arg0, arg1);
}
...
function __wbg_adapter_1238(arg0, arg1, arg2, arg3) {
    wasm.closure1572_externref_shim(arg0, arg1, arg2, arg3);
}
...
const ClientCEP18Finalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_clientcep18_free(ptr >>> 0, 1));
...
class ClientCEP18 {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        ClientCEP18Finalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_clientcep18_free(ptr, 0);
    }
    /**
     ...
     * @param {Verbosity | null} [verbosity]
     */
    constructor(rpc_url, sse_url, verbosity) {
        ...
        var len1 = WASM_VECTOR_LEN;
        const ret = wasm.clientcep18_new(ptr0, len0, ptr1, len1, isLikeNone(verbosity) ? 3 : verbosity);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        ClientCEP18Finalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @returns {string}
    ...
    getRPCUrl() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.clientcep18_getRPCUrl(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    setRPCUrl(rpc_url) {
        const ptr0 = passStringToWasm0(rpc_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.clientcep18_setRPCUrl(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
    ...
    getSSEUrl() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.clientcep18_getSSEUrl(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    /**
     * @param {string} sse_url
     */
    setSSEUrl(sse_url) {
        const ptr0 = passStringToWasm0(sse_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.clientcep18_setSSEUrl(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    getVerbosity() {
        const ret = wasm.clientcep18_getVerbosity(this.__wbg_ptr);
        return ret;
    }
    /**
    ...
    setVerbosity(verbosity) {
        wasm.clientcep18_setVerbosity(this.__wbg_ptr, verbosity);
    }
}
module.exports.ClientCEP18 = ClientCEP18;

const ClientCEP78Finalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_clientcep78_free(ptr >>> 0, 1));
...
class ClientCEP78 {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        ClientCEP78Finalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_clientcep78_free(ptr, 0);
    }
    /**
     * @param {string} rpc_url
     * @param {string | null} [sse_url]
    ...
    constructor(rpc_url, sse_url, verbosity) {
        ...
        var ptr1 = isLikeNone(sse_url) ? 0 : passStringToWasm0(sse_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len1 = WASM_VECTOR_LEN;
        const ret = wasm.clientcep78_new(ptr0, len0, ptr1, len1, isLikeNone(verbosity) ? 3 : verbosity);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        ClientCEP78Finalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @returns {string}
    ...
    getRPCUrl() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.clientcep78_getRPCUrl(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    setRPCUrl(rpc_url) {
        const ptr0 = passStringToWasm0(rpc_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.clientcep78_setRPCUrl(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    getSSEUrl() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.clientcep78_getSSEUrl(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    setSSEUrl(sse_url) {
        const ptr0 = passStringToWasm0(sse_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.clientcep78_setSSEUrl(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
...
module.exports.ClientCEP78 = ClientCEP78;
...
module.exports.__wbg_new_23a2665fac83c611 = function(arg0, arg1) {
    try {
        ...
        var cb0 = (arg0, arg1) => {
            ...
            state0.a = 0;
            try {
                return __wbg_adapter_1238(a, state0.b, arg0, arg1);
            } finally {
                state0.a = a;
            }
        };
...
module.exports.__wbindgen_closure_wrapper3728 = function(arg0, arg1, arg2) {
    const ret = makeMutClosure(arg0, arg1, 907, __wbg_adapter_41);
    return ret;
};

module.exports.__wbindgen_closure_wrapper3730 = function(arg0, arg1, arg2) {
    const ret = makeMutClosure(arg0, arg1, 907, __wbg_adapter_41);
    return ret;
};
...
module.exports.__wbindgen_closure_wrapper478 = function(arg0, arg1, arg2) {
...
const path = require('path').join(__dirname, 'ceps_ts_client_bg.wasm');
