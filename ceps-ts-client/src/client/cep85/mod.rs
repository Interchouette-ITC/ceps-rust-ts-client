use common::{ClientCEP85 as CommonClientCEP85, Verbosity};
use wasm_bindgen::prelude::*;

#[wasm_bindgen(js_name = ClientCEP85)]
pub struct ClientCEP85 {
    client: CommonClientCEP85,
}
...
impl ClientCEP85 {
    ...
    pub fn new(
        ...
        let client = CommonClientCEP85::new(rpc_url, sse_url, verbosity)
