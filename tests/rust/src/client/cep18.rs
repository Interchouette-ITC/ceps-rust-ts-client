...
mod tests {
    ...
    #[test]
    fn test_clientcep18_new_valid_urls() {
        ...
        assert!(client.is_ok(), "Expected ClientCEP18 creation to succeed.");
    }

    #[test]
    fn test_clientcep18_new_invalid_rpc_url() {
        let client = ClientCEP18::new(
        ...
        assert!(
            client.is_err(),
            "Expected ClientCEP18 creation to fail due to invalid RPC URL."
        );
    }

    #[test]
    fn test_clientcep18_get_rpc_url() {
        let client = ClientCEP18::new(
            "http://valid-rpc-url".to_string(),
            Some("http://valid-sse-url".to_string()),
            Some(Verbosity::Low),
    ...
    #[test]
    fn test_clientcep18_set_rpc_url() {
    ...
    #[test]
    fn test_clientcep18_get_sse_url() {
        let client = ClientCEP18::new(
            "http://valid-rpc-url".to_string(),
            Some("http://valid-sse-url".to_string()),
            Some(Verbosity::Low),
    ...
    #[test]
    fn test_clientcep18_set_sse_url() {
        let mut client = ClientCEP18::new(
            "http://valid-rpc-url".to_string(),
            Some("http://valid-sse-url".to_string()),
            Some(Verbosity::Low),
    ...
    #[test]
    fn test_clientcep18_get_verbosity() {
        let client = ClientCEP18::new(
            "http://valid-rpc-url".to_string(),
            Some("http://valid-sse-url".to_string()),
            Some(Verbosity::High),
    ...
    #[test]
    fn test_clientcep18_set_verbosity() {
        let mut client = ClientCEP18::new(
            "http://valid-rpc-url".to_string(),
            Some("http://valid-sse-url".to_string()),
            Some(Verbosity::Low),
