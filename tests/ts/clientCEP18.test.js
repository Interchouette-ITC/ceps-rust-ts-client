...
import { Verbosity, ClientCEP18 } from 'ceps-ts-client';

describe('ClientCEP18 Tests', () => {
  test('should create a client with valid URLs', () => {
    const client = new ClientCEP18(
      'http://valid-rpc-url',
      'http://valid-sse-url',
      Verbosity.Low
    );
  ...
  test('should create a client with valid URLs', () => {
    const client = new ClientCEP18('http://valid-rpc-url');
  ...
  test('should return an error when created with empty URLs', () => {
    expect(() => new ClientCEP18('', undefined, Verbosity.Low)).toThrow();
  });
