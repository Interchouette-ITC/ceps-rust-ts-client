...
export class AddressableEntity {
     ...
     */
    accountHash() {
        const ret = wasm.addressableentity_accountHash(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
    ...
    byteCodeHash() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.addressableentity_byteCodeHash(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    entityKind() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.addressableentity_entityKind(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    protocolVersion() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.addressableentity_protocolVersion(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
export class AddressableEntityInfo {
     ...
     */
    entryPoints() {
        const ret = wasm.addressableentityinfo_entryPoints(this.__wbg_ptr);
...
export class ApiVersionEvent {
    ...
    get apiVersion() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.__wbg_get_apiversionevent_apiVersion(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
export class ByteCode {
     ...
     */
    bytes() {
        const ret = wasm.bytecode_bytes(this.__wbg_ptr);
    ...
    kind() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.bytecode_kind(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
export class CESEvent {
    ...
    data() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.cesevent_data(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    get contractHash() {
        const ret = wasm.__wbg_get_cesevent_contractHash(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
            v1 = getStringFromWasm0(ret[0], ret[1]);
            wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    ...
    get contractPackageHash() {
        const ret = wasm.__wbg_get_cesevent_contractPackageHash(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
            v1 = getStringFromWasm0(ret[0], ret[1]);
            wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    ...
    get dataJson() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.__wbg_get_cesevent_dataJson(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get name() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.__wbg_get_cesevent_name(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
export class CESParseResult {
    ...
    toJson() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.cesparseresult_toJson(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
     ...
     */
    get error() {
        const ret = wasm.__wbg_get_cesparseresult_error(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
            v1 = getStringFromWasm0(ret[0], ret[1]);
            wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
...
export class CESParser {
    ...
    parseExecutionResultJson(execution_result_json) {
        const ptr0 = passStringToWasm0(execution_result_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.cesparser_parseExecutionResultJson(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
    ...
    schemasJson() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.cesparser_schemasJson(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
...
export class CLValue {
    ...
    static fromBool(value) {
        const ret = wasm.clvalue_fromBool(value);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return CLValue.__wrap(ret[0]);
    }
    /**
     * @param {Bytes} bytes
     * @returns {CLValue}
    ...
    static fromBytes(bytes) {
        ...
        const ret = wasm.clvalue_fromBytes(bytes.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return CLValue.__wrap(ret[0]);
    ...
    static fromI32(value) {
        const ret = wasm.clvalue_fromI32(value);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return CLValue.__wrap(ret[0]);
    ...
    static fromI64(value) {
        const ret = wasm.clvalue_fromI64(value);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return CLValue.__wrap(ret[0]);
    ...
    static fromKey(key) {
        ...
        const ret = wasm.clvalue_fromKey(key.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return CLValue.__wrap(ret[0]);
    ...
    static fromPublicKey(public_key) {
        _assertClass(public_key, PublicKey);
        const ret = wasm.clvalue_fromPublicKey(public_key.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return CLValue.__wrap(ret[0]);
    ...
    static fromString(value) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.clvalue_fromString(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return CLValue.__wrap(ret[0]);
    ...
    static fromU128(value) {
        const ptr0 = passStringToWasm0(value, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.clvalue_fromU128(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return CLValue.__wrap(ret[0]);
    ...
    static fromU256(value) {
        const ptr0 = passStringToWasm0(value, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.clvalue_fromU256(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return CLValue.__wrap(ret[0]);
    ...
    static fromU32(value) {
        const ret = wasm.clvalue_fromU32(value);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return CLValue.__wrap(ret[0]);
    ...
    static fromU512(value) {
        const ptr0 = passStringToWasm0(value, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.clvalue_fromU512(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return CLValue.__wrap(ret[0]);
    ...
    static fromU64(value) {
        const ret = wasm.clvalue_fromU64(value);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return CLValue.__wrap(ret[0]);
     ...
     */
    static fromU8(value) {
        const ret = wasm.clvalue_fromU8(value);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return CLValue.__wrap(ret[0]);
    ...
    static fromURef(uref) {
        ...
        const ret = wasm.clvalue_fromURef(uref.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return CLValue.__wrap(ret[0]);
     ...
     */
    static fromUnit() {
        const ret = wasm.clvalue_fromUnit();
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return CLValue.__wrap(ret[0]);
...
export class Cep18Client {
    ...
    balanceOf(account) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.cep18client_balanceOf(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
     * Chain name.
    ...
    chainName() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.cep18client_chainName(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    name() {
        const ret = wasm.cep18client_name(this.__wbg_ptr);
        return ret;
    }
    /**
     * Create a CEP-18 client.
     * @param {string} rpc_url
     * @param {string | null} [sse_url]
     * @param {string | null} [chain_name]
     * @param {number | null} [verbosity]
     */
    constructor(rpc_url, sse_url, chain_name, verbosity) {
        const ptr0 = passStringToWasm0(rpc_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        var ptr1 = isLikeNone(sse_url) ? 0 : passStringToWasm0(sse_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len1 = WASM_VECTOR_LEN;
        var ptr2 = isLikeNone(chain_name) ? 0 : passStringToWasm0(chain_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len2 = WASM_VECTOR_LEN;
        const ret = wasm.cep18client_new(ptr0, len0, ptr1, len1, ptr2, len2, isLikeNone(verbosity) ? 0xFFFFFF : verbosity);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0];
    ...
    rpcUrl() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.cep18client_rpcUrl(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    setContractHash(contract_hash, package_hash) {
        const ptr0 = passStringToWasm0(contract_hash, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        var ptr1 = isLikeNone(package_hash) ? 0 : passStringToWasm0(package_hash, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len1 = WASM_VECTOR_LEN;
        const ret = wasm.cep18client_setContractHash(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        if (ret[1]) {
...
export class Cep78Client {
     ...
     */
    collectionName() {
        const ret = wasm.cep78client_collectionName(this.__wbg_ptr);
        return ret;
    }
    /**
     * Install with defaults (Transferable / Raw / Ordinal) and optional events mode.
     * @param {string} collection_name
     * @param {string} collection_symbol
    ...
    constructor(rpc_url, sse_url, chain_name, verbosity) {
        ...
        var ptr2 = isLikeNone(chain_name) ? 0 : passStringToWasm0(chain_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len2 = WASM_VECTOR_LEN;
        const ret = wasm.cep78client_new(ptr0, len0, ptr1, len1, ptr2, len2, isLikeNone(verbosity) ? 0xFFFFFF : verbosity);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0];
    ...
    rpcUrl() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.cep78client_rpcUrl(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    setContractHash(contract_hash, package_hash) {
        ...
        var ptr1 = isLikeNone(package_hash) ? 0 : passStringToWasm0(package_hash, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len1 = WASM_VECTOR_LEN;
        const ret = wasm.cep78client_setContractHash(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
...
export class Cep85Client {
     ...
     */
    collectionName() {
        const ret = wasm.cep85client_collectionName(this.__wbg_ptr);
        return ret;
    }
    /**
    ...
    constructor(rpc_url, sse_url, chain_name, verbosity) {
        ...
        var ptr2 = isLikeNone(chain_name) ? 0 : passStringToWasm0(chain_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len2 = WASM_VECTOR_LEN;
        const ret = wasm.cep85client_new(ptr0, len0, ptr1, len1, ptr2, len2, isLikeNone(verbosity) ? 0xFFFFFF : verbosity);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0];
    ...
    rpcUrl() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.cep85client_rpcUrl(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    setContractHash(contract_hash, package_hash) {
        ...
        var ptr1 = isLikeNone(package_hash) ? 0 : passStringToWasm0(package_hash, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len1 = WASM_VECTOR_LEN;
        const ret = wasm.cep85client_setContractHash(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
...
export class Contract {
    ...
    contractWasmHash() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.contract_contractWasmHash(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    protocolVersion() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.contract_protocolVersion(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
export class ContractWasm {
     ...
     */
    bytes() {
        const ret = wasm.contractwasm_bytes(this.__wbg_ptr);
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v1;
    }
...
export class DeployInfo {
    ...
    deployHash() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.deployinfo_deployHash(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    gas() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.deployinfo_gas(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    transferAddrs() {
        const ret = wasm.deployinfo_transferAddrs(this.__wbg_ptr);
        var v1 = getArrayJsValueFromWasm0(ret[0], ret[1]);
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
...
export class EntityOrAccount {
    ...
    variant() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.entityoraccount_variant(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
export class EntryPoint {
    ...
    entryPointType() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.entrypoint_entryPointType(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    name() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.entrypoint_name(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
export class EntryPointValue {
     ...
     */
    entryPointType() {
        const ret = wasm.entrypointvalue_entryPointType(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
            v1 = getStringFromWasm0(ret[0], ret[1]);
            wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
     ...
     */
    name() {
        const ret = wasm.entrypointvalue_name(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
            v1 = getStringFromWasm0(ret[0], ret[1]);
            wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    ...
    variant() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.entrypointvalue_variant(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
export class EntryPoints {
     ...
     */
    names() {
        const ret = wasm.entrypoints_names(this.__wbg_ptr);
        var v1 = getArrayJsValueFromWasm0(ret[0], ret[1]);
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
...
export class NamedKeyValue {
     ...
     */
    name() {
        const ret = wasm.namedkeyvalue_name(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
            v1 = getStringFromWasm0(ret[0], ret[1]);
            wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
...
export class NamedKeys {
     ...
     */
    names() {
        const ret = wasm.namedkeys_names(this.__wbg_ptr);
        var v1 = getArrayJsValueFromWasm0(ret[0], ret[1]);
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
...
export class RawEvent {
    ...
    get data() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.__wbg_get_rawevent_data(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get eventType() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.__wbg_get_rawevent_eventType(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get lastEventId() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.__wbg_get_rawevent_lastEventId(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    constructor(event_type, data, last_event_id) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(last_event_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
     ...
     */
    parseAsApiVersion() {
        const ret = wasm.rawevent_parseAsApiVersion(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ApiVersionEvent.__wrap(ret[0]);
    }
    /**
     * @returns {SSEPayload}
     */
    parseAsBlockAdded() {
        const ret = wasm.rawevent_parseAsBlockAdded(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return SSEPayload.__wrap(ret[0]);
    }
    /**
     * @returns {SSEPayload}
     */
    parseAsDeployAccepted() {
        const ret = wasm.rawevent_parseAsDeployAccepted(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return SSEPayload.__wrap(ret[0]);
    ...
    parseAsDeployExpired() {
        const ret = wasm.rawevent_parseAsDeployExpired(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return SSEPayload.__wrap(ret[0]);
    ...
    parseAsDeployProcessed() {
        const ret = wasm.rawevent_parseAsDeployProcessed(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return SSEPayload.__wrap(ret[0]);
     ...
     */
    parseAsFault() {
        const ret = wasm.rawevent_parseAsFault(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return SSEPayload.__wrap(ret[0]);
    ...
    parseAsFinalitySignature() {
        const ret = wasm.rawevent_parseAsFinalitySignature(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return SSEPayload.__wrap(ret[0]);
     ...
     */
    parseAsStep() {
        const ret = wasm.rawevent_parseAsStep(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return SSEPayload.__wrap(ret[0]);
    ...
    parseAsTransactionAccepted() {
        const ret = wasm.rawevent_parseAsTransactionAccepted(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return SSEPayload.__wrap(ret[0]);
    ...
    parseAsTransactionExpired() {
        const ret = wasm.rawevent_parseAsTransactionExpired(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return SSEPayload.__wrap(ret[0]);
    ...
    parseAsTransactionProcessed() {
        const ret = wasm.rawevent_parseAsTransactionProcessed(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return SSEPayload.__wrap(ret[0]);
    ...
    payloadJson(event_name) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.rawevent_payloadJson(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
...
export class RuntimeArgs {
    ...
    insertJsValue(js_value_arg) {
        const ret = wasm.runtimeargs_insertJsValue(this.__wbg_ptr, js_value_arg);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    insertSimple(arg) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.runtimeargs_insertSimple(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    toSessionArgsJson() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.runtimeargs_toSessionArgsJson(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
...
export class SDK {
    ...
    CES_parser(contract_hashes, state_root_hash, rpc_address) {
        var ptr0 = isLikeNone(state_root_hash) ? 0 : passStringToWasm0(state_root_hash, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
        var ptr1 = isLikeNone(rpc_address) ? 0 : passStringToWasm0(rpc_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len1 = WASM_VECTOR_LEN;
        const ret = wasm.sdk_CES_parser(this.__wbg_ptr, contract_hashes, ptr0, len0, ptr1, len1);
        return ret;
    }
    /**
    ...
    get_reward_options(options) {
        const ret = wasm.sdk_get_reward_options(this.__wbg_ptr, options);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return getRewardOptions.__wrap(ret[0]);
    }
    /**
...
export class SSEClient {
    ...
    subscribe(event_name, handler) {
        const ptr0 = passStringToWasm0(event_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.sseclient_subscribe(this.__wbg_ptr, ptr0, len0, handler);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    unsubscribe(event_name) {
        const ptr0 = passStringToWasm0(event_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.sseclient_unsubscribe(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
...
export class SSEPayload {
    ...
    get bodyJson() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.__wbg_get_ssepayload_bodyJson(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get name() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.__wbg_get_ssepayload_name(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    body() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.ssepayload_body(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
...
export class SchemaFieldJson {
    ...
    get clType() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.__wbg_get_schemafieldjson_clType(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get name() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.__wbg_get_schemafieldjson_name(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
export class SessionStrParams {
    ...
    constructor(session_hash, session_name, session_package_hash, session_package_name, session_path, session_bytes, session_args_simple, session_args_json, session_version, session_entry_point, is_session_transfer) {
        ...
        var ptr6 = isLikeNone(session_args_simple) ? 0 : passArrayJsValueToWasm0(session_args_simple, wasm.__wbindgen_malloc);
        var len6 = WASM_VECTOR_LEN;
        var ptr7 = isLikeNone(session_args_json) ? 0 : passStringToWasm0(session_args_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len7 = WASM_VECTOR_LEN;
...
export class StoredValue {
     ...
     */
    asRawBytes() {
        const ret = wasm.storedvalue_asRawBytes(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
    ...
    variant() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.storedvalue_variant(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
export class Transaction {
     ...
     */
    byName() {
        const ret = wasm.transaction_byName(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
            v1 = getStringFromWasm0(ret[0], ret[1]);
            wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
     ...
     */
    session_args_bytes() {
        const ret = wasm.transaction_session_args_bytes(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Bytes.__wrap(ret[0]);
    }
    /**
     * @param {string} secret_key
     * @returns {Transaction}
...
export class TransactionBuilderParams {
     ...
     */
    get runtimeSeed() {
        const ret = wasm.transactionbuilderparams_runtimeSeed(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
            v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
            wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
...
export class Transfer {
    ...
    amount() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.transfer_amount(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    deployHash() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.transfer_deployHash(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    gas() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.transfer_gas(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    id() {
        const ret = wasm.transfer_id(this.__wbg_ptr);
        return ret[0] === 0 ? undefined : BigInt.asUintN(64, ret[1]);
    }
    /**
     * @returns {URef}
...
export function contractHashKeyForGlobalState(formatted) {
    ...
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(formatted, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.contractHashKeyForGlobalState(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
export class getRewardOptions {
    ...
    get delegator_public_key_as_string() {
        const ret = wasm.__wbg_get_getrewardoptions_delegator_public_key_as_string(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
            v1 = getStringFromWasm0(ret[0], ret[1]);
            wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    ...
    get maybe_era_id_as_string() {
        const ret = wasm.__wbg_get_getrewardoptions_maybe_era_id_as_string(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
            v1 = getStringFromWasm0(ret[0], ret[1]);
            wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
     ...
     */
    get maybe_era_id() {
        const ret = wasm.__wbg_get_getrewardoptions_maybe_era_id(this.__wbg_ptr);
        return ret[0] === 0 ? undefined : BigInt.asUintN(64, ret[1]);
    }
    /**
     * @returns {string | undefined}
     */
    get rpc_address() {
        const ret = wasm.__wbg_get_getrewardoptions_rpc_address(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
            v1 = getStringFromWasm0(ret[0], ret[1]);
            wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    ...
    get validator_public_key_as_string() {
        const ret = wasm.__wbg_get_getrewardoptions_validator_public_key_as_string(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
            v1 = getStringFromWasm0(ret[0], ret[1]);
            wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_new_typed_cceaf62d8d95e9f2: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return wasm_bindgen_ed405e00f3e7d056___convert__closures_____invoke___js_sys_5798089239231dc3___Function_fn_wasm_bindgen_ed405e00f3e7d056___JsValue_____wasm_bindgen_ed405e00f3e7d056___sys__Undefined___js_sys_5798089239231dc3___Function_fn_wasm_bindgen_ed405e00f3e7d056___JsValue_____wasm_bindgen_ed405e00f3e7d056___sys__Undefined_______true_(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [Externref], shim_idx: 1149, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen_ed405e00f3e7d056___convert__closures_____invoke___wasm_bindgen_ed405e00f3e7d056___JsValue______true_);
            return ret;
        },
        __wbindgen_cast_0000000000000002: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [Externref], shim_idx: 1656, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen_ed405e00f3e7d056___convert__closures_____invoke___wasm_bindgen_ed405e00f3e7d056___JsValue__core_7a2330d63e03cc2c___result__Result_____wasm_bindgen_ed405e00f3e7d056___JsError___true_);
            return ret;
        },
...
function wasm_bindgen_ed405e00f3e7d056___convert__closures_____invoke___wasm_bindgen_ed405e00f3e7d056___JsValue______true_(arg0, arg1, arg2) {
    wasm.wasm_bindgen_ed405e00f3e7d056___convert__closures_____invoke___wasm_bindgen_ed405e00f3e7d056___JsValue______true_(arg0, arg1, arg2);
}

function wasm_bindgen_ed405e00f3e7d056___convert__closures_____invoke___wasm_bindgen_ed405e00f3e7d056___JsValue__core_7a2330d63e03cc2c___result__Result_____wasm_bindgen_ed405e00f3e7d056___JsError___true_(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen_ed405e00f3e7d056___convert__closures_____invoke___wasm_bindgen_ed405e00f3e7d056___JsValue__core_7a2330d63e03cc2c___result__Result_____wasm_bindgen_ed405e00f3e7d056___JsError___true_(arg0, arg1, arg2);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

function wasm_bindgen_ed405e00f3e7d056___convert__closures_____invoke___js_sys_5798089239231dc3___Function_fn_wasm_bindgen_ed405e00f3e7d056___JsValue_____wasm_bindgen_ed405e00f3e7d056___sys__Undefined___js_sys_5798089239231dc3___Function_fn_wasm_bindgen_ed405e00f3e7d056___JsValue_____wasm_bindgen_ed405e00f3e7d056___sys__Undefined_______true_(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen_ed405e00f3e7d056___convert__closures_____invoke___js_sys_5798089239231dc3___Function_fn_wasm_bindgen_ed405e00f3e7d056___JsValue_____wasm_bindgen_ed405e00f3e7d056___sys__Undefined___js_sys_5798089239231dc3___Function_fn_wasm_bindgen_ed405e00f3e7d056___JsValue_____wasm_bindgen_ed405e00f3e7d056___sys__Undefined_______true_(arg0, arg1, arg2, arg3);
}
