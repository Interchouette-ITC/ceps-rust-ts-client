...
export interface InitOutput {
    ...
    readonly __wbg_get_apiversionevent_apiVersion: (a: number) => [number, number];
    readonly __wbg_get_body_transaction_processed: (a: number) => number;
    readonly __wbg_get_cesevent_contractHash: (a: number) => [number, number];
    readonly __wbg_get_cesevent_contractPackageHash: (a: number) => [number, number];
    readonly __wbg_get_cesevent_dataJson: (a: number) => [number, number];
    readonly __wbg_get_cesevent_eventId: (a: number) => bigint;
    readonly __wbg_get_cesevent_name: (a: number) => [number, number];
    readonly __wbg_get_cesevent_transformIdx: (a: number) => number;
    readonly __wbg_get_cesparseresult_error: (a: number) => [number, number];
    ...
    readonly __wbg_get_getrewardoptions_delegator_public_key_as_string: (a: number) => [number, number];
    readonly __wbg_get_getrewardoptions_maybe_block_identifier: (a: number) => number;
    readonly __wbg_get_getrewardoptions_maybe_era_id: (a: number) => [number, bigint];
    readonly __wbg_get_getrewardoptions_maybe_era_id_as_string: (a: number) => [number, number];
    readonly __wbg_get_getrewardoptions_rpc_address: (a: number) => [number, number];
    readonly __wbg_get_getrewardoptions_validator_public_key: (a: number) => number;
    readonly __wbg_get_getrewardoptions_validator_public_key_as_string: (a: number) => [number, number];
    ...
    readonly account_toJson: (a: number) => any;
    ...
    readonly addressableentity_accountHash: (a: number) => [number, number];
    readonly addressableentity_byteCodeHash: (a: number) => [number, number];
    readonly addressableentity_entityKind: (a: number) => [number, number];
    readonly addressableentity_mainPurse: (a: number) => number;
    readonly addressableentity_protocolVersion: (a: number) => [number, number];
    readonly addressableentity_toJson: (a: number) => any;
    ...
    readonly addressableentityinfo_entryPoints: (a: number) => [number, number];
    readonly addressableentityinfo_namedKeys: (a: number) => number;
    readonly addressableentityinfo_toJson: (a: number) => any;
    ...
    readonly bytecode_bytes: (a: number) => [number, number];
    readonly bytecode_isEmpty: (a: number) => number;
    readonly bytecode_kind: (a: number) => [number, number];
    readonly bytecode_len: (a: number) => number;
    readonly bytecode_toJson: (a: number) => any;
    ...
    readonly cesevent_data: (a: number) => [number, number];
    readonly cesparser_contractCount: (a: number) => number;
    readonly cesparser_new: () => number;
    readonly cesparser_parseExecutionResultJson: (a: number, b: number, c: number) => [number, number, number];
    readonly cesparser_schemasJson: (a: number) => [number, number, number, number];
    readonly cesparseresult_toJson: (a: number) => [number, number, number, number];
    readonly clvalue_fromBool: (a: number) => [number, number, number];
    readonly clvalue_fromBytes: (a: number) => [number, number, number];
    readonly clvalue_fromI32: (a: number) => [number, number, number];
    readonly clvalue_fromI64: (a: bigint) => [number, number, number];
    readonly clvalue_fromKey: (a: number) => [number, number, number];
    readonly clvalue_fromPublicKey: (a: number) => [number, number, number];
    readonly clvalue_fromString: (a: number, b: number) => [number, number, number];
    readonly clvalue_fromU128: (a: number, b: number) => [number, number, number];
    readonly clvalue_fromU256: (a: number, b: number) => [number, number, number];
    readonly clvalue_fromU32: (a: number) => [number, number, number];
    readonly clvalue_fromU512: (a: number, b: number) => [number, number, number];
    readonly clvalue_fromU64: (a: bigint) => [number, number, number];
    readonly clvalue_fromU8: (a: number) => [number, number, number];
    readonly clvalue_fromURef: (a: number) => [number, number, number];
    readonly clvalue_fromUnit: () => [number, number, number];
    readonly clvalue_toJson: (a: number) => any;
    readonly contractHashKeyForGlobalState: (a: number, b: number) => [number, number];
    readonly contract_contractWasmHash: (a: number) => [number, number];
    ...
    readonly contract_protocolVersion: (a: number) => [number, number];
    readonly contract_toJson: (a: number) => any;
    ...
    readonly contractpackage_toJson: (a: number) => any;
    ...
    readonly contractwasm_bytes: (a: number) => [number, number];
    readonly contractwasm_isEmpty: (a: number) => number;
    readonly contractwasm_len: (a: number) => number;
    readonly contractwasm_toJson: (a: number) => any;
    ...
    readonly deployinfo_deployHash: (a: number) => [number, number];
    readonly deployinfo_fromAccount: (a: number) => number;
    readonly deployinfo_gas: (a: number) => [number, number];
    readonly deployinfo_source: (a: number) => number;
    readonly deployinfo_toJson: (a: number) => any;
    readonly deployinfo_transferAddrs: (a: number) => [number, number];
    ...
    readonly entityoraccount_toJson: (a: number) => any;
    readonly entityoraccount_variant: (a: number) => [number, number];
    readonly entrypoint_entryPointType: (a: number) => [number, number];
    readonly entrypoint_name: (a: number) => [number, number];
    readonly entrypoint_toJson: (a: number) => any;
    ...
    readonly entrypoints_names: (a: number) => [number, number];
    readonly entrypoints_toJson: (a: number) => any;
    readonly entrypointvalue_entryPointType: (a: number) => [number, number];
    readonly entrypointvalue_toJson: (a: number) => any;
    readonly entrypointvalue_variant: (a: number) => [number, number];
    readonly eraid_value: (a: number) => bigint;
    readonly erainfo_seigniorageAllocationCount: (a: number) => number;
    readonly erainfo_toJson: (a: number) => any;
    ...
    readonly getrewardresult_api_version: (a: number) => any;
    readonly getrewardresult_delegation_rate: (a: number) => number;
    readonly getrewardresult_era_id: (a: number) => any;
    readonly getrewardresult_reward_amount: (a: number) => any;
    readonly getrewardresult_switch_block_hash: (a: number) => any;
    readonly getrewardresult_toJson: (a: number) => any;
    ...
    readonly rawevent_parseAsApiVersion: (a: number) => [number, number, number];
    readonly rawevent_parseAsBlockAdded: (a: number) => [number, number, number];
    readonly rawevent_parseAsDeployAccepted: (a: number) => [number, number, number];
    readonly rawevent_parseAsDeployExpired: (a: number) => [number, number, number];
    readonly rawevent_parseAsDeployProcessed: (a: number) => [number, number, number];
    readonly rawevent_parseAsFault: (a: number) => [number, number, number];
    readonly rawevent_parseAsFinalitySignature: (a: number) => [number, number, number];
    readonly rawevent_parseAsStep: (a: number) => [number, number, number];
    readonly rawevent_parseAsTransactionAccepted: (a: number) => [number, number, number];
    readonly rawevent_parseAsTransactionExpired: (a: number) => [number, number, number];
    readonly rawevent_parseAsTransactionProcessed: (a: number) => [number, number, number];
    readonly rawevent_payloadJson: (a: number, b: number, c: number) => [number, number, number, number];
    readonly runtimeargs_insert: (a: number, b: number, c: number, d: number) => void;
    readonly runtimeargs_insertJsValue: (a: number, b: any) => [number, number];
    readonly runtimeargs_insertSimple: (a: number, b: number, c: number) => [number, number];
    readonly runtimeargs_new: () => number;
    readonly runtimeargs_toJson: (a: number) => any;
    readonly runtimeargs_toSessionArgsJson: (a: number) => [number, number, number, number];
    readonly sdk_CES_parser: (a: number, b: any, c: number, d: number, e: number, f: number) => any;
    ...
    readonly sdk_call_entrypoint: (a: number, b: number, c: number, d: number, e: number, f: number) => any;
    ...
    readonly sdk_get_reward: (a: number, b: number) => any;
    readonly sdk_get_reward_options: (a: number, b: any) => [number, number, number];
    ...
    readonly sdk_info_get_reward: (a: number, b: number) => any;
    ...
    readonly sdk_install: (a: number, b: number, c: number, d: number, e: number, f: number) => any;
    ...
    readonly sseclient_start: (a: number, b: number, c: bigint) => any;
    readonly sseclient_stop: (a: number) => void;
    readonly sseclient_subscribe: (a: number, b: number, c: number, d: any) => [number, number];
    readonly sseclient_unsubscribe: (a: number, b: number, c: number) => [number, number];
    readonly ssepayload_body: (a: number) => [number, number, number, number];
    ...
    readonly storedvalue_asRawBytes: (a: number) => [number, number];
    readonly storedvalue_asSmartContract: (a: number) => number;
    readonly storedvalue_asTransfer: (a: number) => number;
    readonly storedvalue_toJson: (a: number) => any;
    readonly storedvalue_variant: (a: number) => [number, number];
    ...
    readonly transaction_byName: (a: number) => [number, number];
    ...
    readonly transaction_session_args_bytes: (a: number) => [number, number, number];
    ...
    readonly transactionbuilderparams_runtimeSeed: (a: number) => [number, number];
    ...
    readonly transfer_amount: (a: number) => [number, number];
    readonly transfer_deployHash: (a: number) => [number, number];
    readonly transfer_fromAccount: (a: number) => number;
    readonly transfer_gas: (a: number) => [number, number];
    readonly transfer_id: (a: number) => [number, bigint];
    readonly transfer_source: (a: number) => number;
    readonly transfer_target: (a: number) => number;
    readonly transfer_to: (a: number) => number;
    readonly transfer_toJson: (a: number) => any;
    ...
    readonly __wbg_get_rawevent_data: (a: number) => [number, number];
    readonly __wbg_get_rawevent_eventType: (a: number) => [number, number];
    readonly __wbg_get_rawevent_lastEventId: (a: number) => [number, number];
    readonly __wbg_get_schemafieldjson_clType: (a: number) => [number, number];
    readonly __wbg_get_schemafieldjson_name: (a: number) => [number, number];
    readonly __wbg_get_ssepayload_bodyJson: (a: number) => [number, number];
    readonly __wbg_get_ssepayload_name: (a: number) => [number, number];
    ...
    readonly entrypointvalue_name: (a: number) => [number, number];
    ...
    readonly wasm_bindgen_ed405e00f3e7d056___convert__closures_____invoke___wasm_bindgen_ed405e00f3e7d056___JsValue__core_7a2330d63e03cc2c___result__Result_____wasm_bindgen_ed405e00f3e7d056___JsError___true_: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen_ed405e00f3e7d056___convert__closures_____invoke___js_sys_5798089239231dc3___Function_fn_wasm_bindgen_ed405e00f3e7d056___JsValue_____wasm_bindgen_ed405e00f3e7d056___sys__Undefined___js_sys_5798089239231dc3___Function_fn_wasm_bindgen_ed405e00f3e7d056___JsValue_____wasm_bindgen_ed405e00f3e7d056___sys__Undefined_______true_: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen_ed405e00f3e7d056___convert__closures_____invoke___wasm_bindgen_ed405e00f3e7d056___JsValue______true_: (a: number, b: number, c: any) => void;
