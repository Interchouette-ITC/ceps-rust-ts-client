...
export interface InitOutput {
  ...
  readonly client_new: (a: number, b: number, c: number, d: number, e: number) => number;
  readonly client_getRPCAddress: (a: number, b: number, c: number) => [number, number];
  readonly client_setRPCAddress: (a: number, b: number, c: number) => [number, number];
  readonly client_getNodeAddress: (a: number, b: number, c: number) => [number, number];
  readonly client_setNodeAddress: (a: number, b: number, c: number) => [number, number];
  readonly client_getVerbosity: (a: number, b: number) => number;
  readonly client_setVerbosity: (a: number, b: number) => [number, number];
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h32c0a5dba3612109: (a: number, b: number) => void;
  readonly closure900_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure1078_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure1568_externref_shim: (a: number, b: number, c: any, d: any) => void;
